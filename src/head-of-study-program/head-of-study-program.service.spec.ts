...
describe('HeadOfStudyProgramService', () => {
  ...
  describe('deleteMultiple', () => {
    ...
    it("should throw NotFoundException if head of study program is not found", async () => {
      ...
      await expect(headOfStudyProgramService.deleteMultiple(allHeadsId)).rejects.toThrow(
        NotFoundException,
      );
      expect(prismaMock.headStudyProgram.deleteMany).toHaveBeenCalledTimes(0)
    });
  ...
  describe('getHeadById', () => {
    ...
    it('should throw NotFoundException if the head of study program does not exist', async () => {
      ...
      await expect(headOfStudyProgramService.getHeadById(idNotExist)).rejects.toThrow(NotFoundException);
    });
     ...
     it('should throw NotFoundException if the user does not exist', async () => {
      ...
      await expect(headOfStudyProgramService.getHeadById(id)).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('getManyHeadsByIds', () => {
    ...
    it('should return head of study programs', async () => {
      ...
      expect(await headOfStudyProgramService.getManyHeadByIds(allHeadsId)).toEqual(allHeads);
    });
    ...
    it('should  throw NotFoundException if a head of study program does not exist', async () => {
      ...
      await expect(headOfStudyProgramService.getManyHeadByIds(ids)).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('isStudyProgramAvailable', () => {
    ...
    it('should return false if study program is not available', async () => {
      ...
      expect(await headOfStudyProgramService.isStudyProgramAvailable(id, studyProgramIdNotAvail)).toEqual(false);
    });
  });
});
